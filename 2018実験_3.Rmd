...
まず今回の基礎となる, ベイズの定理について復習する. 簡単に説明するが, もしわからない場合は必ず各自復習すること.
...
## 条件付き確率に関する練習問題 {.tabset .tabset-fade}
...
サポートベクターマシンは, 最大マージンを実現する2クラス線形識別関数の学習法である. 最大マージンとは, 学習データの中で最も他のクラスと近い位置にいるもの(サポートベクトル)を基準として, その二つのデータについて, それぞれユークリッド距離が夫も大きくなるような位置に識別境界を定めることである.
